  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='mt-4 flex gap-4 text-sm'>
        <button onClick={handleNavigate} className='bg-blue-600 text-white px-4 py-2 rounded'>Apply now</button>
        <button onClick={handleNavigate} className='text-gray-500 border border-gray-500 rounded px-4 py-2'>Learn more</button>
      </div>
    </div>
  )
}
